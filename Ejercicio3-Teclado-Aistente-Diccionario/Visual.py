...
# Este llama a una funcion cuando se ahce click en algun
#contenido del Listboxscroll = Scrollbar(ventana, orient=VERTICAL)
...
agregarpalabra.grid(row=4, column=1, sticky=W)
...
command=borrar)
boton14.grid(row=2, column=1, sticky=E)

boton14 = Button(ventana, text="Agregar\npalabra", activeforeground='green',\
activebackground='black', bg='black', fg='white', height=2, width=4,\
command=agregar)
boton14.grid(row=3, column=1, sticky=W)

boton14 = Button(ventana, text="Modificar\npalabra", activeforeground='green',\
activebackground='black', bg='black', fg='white', height=2, width=5,\
command=modificar)
boton14.grid(row=3, column=1, sticky=E)
